                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Đồ Nữ &nbsp;&nbsp;</a>
                                ...
                                <?php echo $this->Form->create('Product',array('action' => 'get_keyword','class' => 'sidebar-form'),array('class' => 'sidebar-form'));?>
                                    ...
                                    <?php echo $this->Form->input('keyword',array('label' => '','placeholder' => 'Nhập từ khoá có dấu....','class'=>'form-control search')); ?>
