...
public function checkout(){
		...
		if($this->request->is('post')){
			...
			// $to = 'danhchutich@gmail.com';  //khai báo địa chỉ mail người nhận
			...
			// $headers = "From: tuphuongdanh1996@gmail.com";
			//  //Gửi mail
			...
			// }
				...
				// $Email->from(array('danhtp@student.passerellesnumeriques.org' => 'My Site'));
				// $Email->to('danhchutich@gmail.com');
				// $Email->subject('Cam on ban da mua hang');
				// $Email->send('Cam on');
				$this->Session->delete('cart');
				$this->Session->delete('payment');
				// // $Email = new CakeEmail('smtp');
				// // $Email->from(array('danhchutich@gmail.com' => 'My Site'));
				// // $Email->to('tuphuongdanh1996@gmail.com');
				// // $Email->subject('About');
